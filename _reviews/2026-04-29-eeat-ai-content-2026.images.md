# Image Pack — eeat-ai-content-2026
...
SUBJECT: A single thick slab of dark slate, roughly book-sized, with one
natural cleaved face, chipped layered edges, fine mineral dust, and one
subtle rust-colored inclusion embedded in the stone.

SCENE: The slate slab leans a few degrees from vertical on a dark matte stone
surface, revealing the layered edge and tactile cleaved texture.
...
MUST KEEP: Exactly one slate slab, not a stack or collection. Consistent light
...
- 원본: `assets/img/posts/eeat-ai-content-2026-cover-raw.png`
- 최종: `assets/img/posts/eeat-ai-content-2026-cover.jpg`
