# Image Pack — youtube-ai-monetization-2026

## 대상

- 슬러그: `youtube-ai-monetization-2026`
- 포맷: C (기술 가이드)
...
SUBJECT: A single palm-sized fragment of thick copper plate with an irregular
torn edge, patches of blue-green oxidation, fine scratches, and exposed warm
metal along one chipped corner.

SCENE: The copper fragment stands at a slight angle against a nearly invisible
dark stone support, its textured face catching raking light.
...
MUST KEEP: Exactly one copper fragment, not a stack or collection. Consistent
...
- 원본: `assets/img/posts/youtube-ai-monetization-2026-cover-raw.png`
- 최종: `assets/img/posts/youtube-ai-monetization-2026-cover.jpg`
