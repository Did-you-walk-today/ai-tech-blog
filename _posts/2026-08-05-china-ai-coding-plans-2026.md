...
Figures were collected on 2026-07-28, re-verified on 2026-08-01, and re-verified again on 2026-08-05 by fetching each vendor's official English-language documentation directly. Sources: Z.ai developer documentation for GLM, Alibaba Cloud Model Studio help pages for Qwen, the MiniMax platform token-plan documentation, Moonshot's Kimi Code documentation and help centre for Kimi, and DeepSeek's API pricing documentation.
