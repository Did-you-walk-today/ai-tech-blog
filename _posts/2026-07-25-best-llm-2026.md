...
image:
  ...
  alt: "Normalized comparison matrix of 2026 LLM operational limits — context window, max output tokens, prompt cache minimums, and model retirement dates across Anthropic, OpenAI, Google, xAI, and DeepSeek"
faq:
