...
last_modified_at: 2026-09-14 16:10:00 +0900
...
As of September 14, 2026, LLM API prices span two orders of magnitude — from $0.10 per million input tokens (Gemini 2.5 Flash-Lite) to $30.00 (GPT-5.5-pro and GPT-5.4-pro). Forty-six of the 47 tracked rows did not move — a third consecutive week without a price change on the carried set. The single change is not a price cut. [DeepSeek's pricing page](https://api-docs.deepseek.com/quick_start/pricing) now states that v4-flash has been retired and that requests to that name are served by a different model, `deepseek-flash`, at $0.15 / $0.60.

The distinction matters because the numbers fell. Input went from $0.22 to $0.15, within a cent of the $0.14 DeepSeek charged before its August 17 increase. Output did not follow: $0.60 now, against $0.28 in that same pre-increase week. The August increase was reversed on input and kept on output, through a model swap rather than a repricing.

One ratio carries the whole story. Before August 17, DeepSeek charged 2x as much for output as for input. After the increase, 3x. Now 4x. Each step moved it further from the cheap-generation model it launched as, and closer to the 3–6x every other provider on this page charges. The cache column moved the opposite way: a hit now costs 2% of base input, a 98% discount that takes the deepest-cache title back from Claude Fable 5.1 one week after Anthropic took it.

Every price below was collected on September 14, 2026 directly from the six providers' official pricing pages and normalized to USD per 1M tokens at the standard (non-batch) tier.

## TL;DR

- **Cheapest overall**: Gemini 2.5 Flash-Lite ($0.10 / $0.40), still ahead of the cheaper DeepSeek row that arrived on September 14 at $0.15 / $0.60
...
- **The deepest cache discount changed hands twice in eight days**: DeepSeek's new `deepseek-flash` bills a cache hit at 2% of base input — 98% off, retaking the lead from the 97.5% Claude Fable 5.1 held for one week
...
> *Added 2026-09-07 and unchanged since: **Claude Fable 5.1** matches Fable 5's $10.00 / $50.00 but prices a cache hit at $0.25 per 1M — 0.025x base input, against the 0.1x every other Claude row carries. **GPT-6-astra** arrives on the same $10.00 / $50.00 sticker, with a long-context tier at $20.00 / $75.00 (cache read $2.00). Claude Mythos 5.1 is priced identically to Fable 5.1 but is application-gated, so like Mythos 5 it is carried in our snapshot without a row here. No price in this table has moved in three collections. GPT-5.6-sol's $4.00 / $20.00 is promotional, stated available at least through 2026-11-21, with a long-context tier at $8.00 / $30.00 (cache read $0.80). Google bills Gemini 3.1 Pro Preview at a higher tier above 200K tokens; xAI bills both Grok 4.6 and 4.5 at $4.00 / $12.00 above 200K, with cache reads of $1.00 and $0.60 respectively. Claude Opus 4.5 through 4.8 share Opus 5's $5.00 / $25.00 pricing. "n/p" = not published on the provider's pricing page.
